...
| `src/main/modules/automation/browserview-capture-service.ts` | 自动化截图归一化、区域捕获、FrameGeometry 与兼容帧复用 |
| `src/main/modules/automation/browserview-coordinate-adapter.ts` | logical/display 坐标与裁剪区域换算 |
