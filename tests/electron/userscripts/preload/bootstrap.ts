// BrowserView preload entry for the demo userscript runtime.
// Bundled to release/tests/userscript-runtime-preload.cjs by
// tests/electron/build-userscript-runtime-smoke.mjs.

import { ipcRenderer, webFrame } from 'electron';
import type { FrameSnapshot } from '../userscript-types';
