...
const ALLOWED_INVOKE_CHANNELS = new Set([
  ...
  'automation:capture-asset-frame', 'automation:save-captured-asset',
    'automation:open-test-scene', 'automation:test-asset-on-scene', 'automation:import-asset-files', 'automation:test-text-on-scene',
...
const electronAPI = {
  ...
  automation: {
    ...
    testTextOnScene: (token: string, text: string, match: 'contains' | 'exact', minScore: number) => safeInvoke('automation:test-text-on-scene', { token, text, match, minScore }),
