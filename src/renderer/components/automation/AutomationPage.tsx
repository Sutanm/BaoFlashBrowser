      ...
      <div className="automation-page-body">
        <aside className="automation-library">
          ...
          {selectedId && <div className="automation-assets-list">
            <div><Image /><strong>{LL.automation.page.assetsTitle()}</strong><span>{assets.length}</span><button type="button" onClick={() => void importAssets()} disabled={busy} title={LL.automation.page.mergeAssetsTitle()}><FolderPlus />{LL.automation.page.add()}</button></div>
