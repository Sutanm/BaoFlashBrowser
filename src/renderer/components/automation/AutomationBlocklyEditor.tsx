...
function buildToolbox(LL: ReturnType<typeof useI18nContext>['LL']): Blockly.utils.toolbox.ToolboxDefinition {
  ...
  return {
    ...
    contents: [
      ...
      { kind: 'category', name: b.catFlow(), colour: '330', contents: ['bao_if_condition', 'bao_wait_condition', 'bao_wait_condition_branch', 'bao_repeat_until_condition', 'bao_condition_image', 'bao_condition_position', 'bao_condition_and', 'bao_condition_or', 'bao_condition_not', 'bao_if_image', 'bao_position_compare', 'bao_repeat', 'bao_forever', 'bao_break', 'bao_repeat_until_image'].map((type) => ({ kind: 'block', type })) },
