...
const en: Translation = {
  ...
  automation: {
    page: {
      ...
      searchAssets: 'Search assets or folders', rootFolder: 'Root', linkFolder: 'Link folder', syncFolder: 'Sync', linkFolderTitle: 'Select an asset folder to link', folderLinked: 'Linked {name}; found {count} assets', folderSynced: 'Sync complete: {changed} added or updated, {missing} missing from folder (not deleted)',
    ...
    testBench: {
      ...
      threshold: 'Threshold {value}%', multiScale: 'Multi-scale', scaleMin: 'Min', scaleMax: 'Max', scaleStep: 'Step', alphaMask: 'Alpha mask', compare: 'Compare', comparing: 'Comparing',
    ...
    blockly: {
      ...
      clickImage: 'Click image %1 with %2 %3 time(s) at %4 verify %5 max move %6 px',
      ...
      imageCondition: 'Image %1 matches %2',
