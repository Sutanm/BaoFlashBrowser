...
const zhCN: BaseTranslation = {
  ...
  automation: {
    page: {
      ...
      searchAssets: '搜索素材或目录', rootFolder: '根目录', linkFolder: '关联目录', syncFolder: '同步', linkFolderTitle: '选择要关联的素材目录', folderLinked: '已关联 {name}，发现 {count} 个素材', folderSynced: '同步完成：新增或更新 {changed} 个，目录中缺少 {missing} 个（未自动删除）',
    ...
    testBench: {
      ...
      threshold: '阈值 {value}%', multiScale: '多尺度', scaleMin: '最小', scaleMax: '最大', scaleStep: '步长', alphaMask: '透明遮罩', compare: '开始比对', comparing: '比对中',
    ...
    blockly: {
      ...
      clickImage: '点击图片 %1 %2 %3 次 相似度 %4 点击前确认 %5 最大移动 %6 像素',
