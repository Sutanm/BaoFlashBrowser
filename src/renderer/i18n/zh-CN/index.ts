...
const zhCN: BaseTranslation = {
  ...
  automation: {
    ...
    blockly: {
      ...
      execute: '执行 %1',
      start: '识别到 %1 相似度 %2 匹配 %3 时就绪',
      waitImage: '等待图片 %1 相似度 %2 匹配 %3 超时 %4 毫秒',
      waitImageState: '等待图片 %1 %2 匹配 %3 超时 %4 毫秒',
      clickImage: '点击 %1 %2 %3 %4 次 相似度 %5 匹配 %6 点击前确认 %7 最大移动 %8 像素',
      coordinateTarget: '填写坐标',
      moveToImage: '移动到图片 %1 相似度 %2 匹配 %3',
      moveToTarget: '移动鼠标到 %1 %2 相似度 %3 匹配 %4',
      dragImage: '拖拽图片 %1 相似度 %2 匹配 %3 到 %4 相似度 %5 匹配 %6 使用 %7 持续 %8 毫秒 超时 %9 毫秒',
      dragTarget: '拖拽 %1 %2 相似度 %3 匹配 %4 到 %5 %6 相似度 %7 匹配 %8 使用 %9 持续 %10 毫秒 超时 %11 毫秒',
      delay: '等待 %1 毫秒',
      keyPress: '按键 %1',
      keyCombo: '组合键 Ctrl %1 Alt %2 Shift %3 Win %4 + %5',
      holdKeyUntilImage: '按住 %1 直到图片 %2 %3 匹配 %4 超时 %5 毫秒',
      ...
      ifImage: '如果 %1 图片 %2 相似度 %3 匹配 %4',
      ifCondition: '如果条件 %1',
      imageCondition: '图片 %1 相似度 %2 匹配 %3',
      conditionAnd: '%1 并且 %2',
      conditionOr: '%1 或者 %2',
      conditionNot: '不满足 %1',
      positionCondition: '目标A %1 %2 偏移 %7,%8 相对B %9 %10 偏移 %15,%16 关系 %17 容差 %18 px',
      positionCompare: '如果 目标A %1 %2 偏移 %7,%8 相对B %9 %10 偏移 %15,%16 关系 %17 容差 %18 px',
      imageTarget: '图片',
      relationVertical: '垂直对齐',
      relationHorizontal: '水平对齐',
      relationOverlap: '重合',
      waitCondition: '等待直到条件 %1 超时 %2 毫秒',
      waitConditionBranch: '等待条件 %1 最多 %2 毫秒',
      onSuccess: '成功时 %1',
      onTimeout: '超时时 %1',
      then: '那么 %1',
      otherwise: '否则 %1',
      repeat: '重复 %1 次',
      repeatUntilImage: '重复直到图片 %1 %2 匹配 %3 最多 %4 次',
