...
const zhCN: BaseTranslation = {
  ...
  automation: {
    ...
    blockly: {
      ...
      waitTextState: '等待文字 %1 %2 匹配 %3',
      clickText: '点击文字 %1 匹配 %2 使用 %3 %4 次',
      textCondition: '文字 %1 匹配 %2 置信度 %3',
      textContains: '包含',
      textExact: '完全相同',
      ocrScoreRow: '最低置信度 %1',
      ocrRequired: '需要 BaoFlashBrowser OCR 版；标准版可编辑积木，但执行时会提示安装 OCR 版。',
    ...
    service: {
      ...
      status: {
        ...
        textMatch: '识别到文字 {text} · {score}% · 总耗时 {totalMs}ms（截图 {captureMs}ms）',
