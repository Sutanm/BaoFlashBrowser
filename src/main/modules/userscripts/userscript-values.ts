...
export function isSerializableValue(value: unknown): value is GMSerializable {
  ...
  // references, matching JSON.stringify semantics. Explicit budgets keep a
  // hostile IPC value from exhausting the main-process stack or CPU before
  // the serialized-byte limit is applied by UserscriptValueStore.
